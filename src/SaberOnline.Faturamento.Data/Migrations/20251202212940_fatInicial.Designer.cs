...
namespace SaberOnline.Faturamento.Data.Migrations
{
    ...
    [Migration("20251202212940_fatInicial")]
    partial class fatInicial
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SaberOnline.Faturamento.Domain.Entities.Pagamento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SaberOnline.Faturamento.Domain.Entities.Pagamento", b =>
                {
                    b.OwnsOne("SaberOnline.Faturamento.Domain.ValueObjects.DadosCartao", "Cartao", b1 =>
                        {
                    ...
                    b.OwnsOne("SaberOnline.Faturamento.Domain.ValueObjects.StatusPagamento", "StatusPagamento", b1 =>
                        {
                            b1.Property<Guid>("PagamentoId")
                                .HasColumnType("UniqueIdentifier");
